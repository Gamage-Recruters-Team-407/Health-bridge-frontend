...
export const Card: React.FC<CardProps> = ({
  ...
  const variants = {
    default:
      "bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-sm rounded-2xl",
    bordered:
      "bg-white dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-700 rounded-2xl",
    glass:
      "bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border border-white/20 dark:border-slate-800/80 shadow-lg rounded-2xl",
    interactive:
      "bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-sm hover:shadow-md hover:border-blue-300 dark:hover:border-blue-700 transition-all duration-200 cursor-pointer rounded-2xl",
  };
