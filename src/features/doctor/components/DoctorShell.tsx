...
import { CalendarDays, Check, CircleDollarSign, Clock3, LayoutDashboard, Menu, Stethoscope, UserRound, X, PlaneTakeoff, Bell, Search, FileSpreadsheet, Video } from "lucide-react";
const navigation = [
